...
func (c *customerRepo) GetCustomerCars(req models.GetAllCustomersRequest) ([]models.GetOrder, error) {
...
func (o *customerRepo) GetByIDCustomerCar(id string) (models.GetOrder, error) {
